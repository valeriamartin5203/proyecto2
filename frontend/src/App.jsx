...
function App() {
  ...
  return (
    <div className="container">
      <Navbar usuario={usuario} onLogout={handleLogout} serverStatus={serverStatus} />
      ...
      <div className="grid">
          ...
          {!usuario ? (
            <>
              ...
              <div className="tabs">
                ...
                <div className={`tab ${activeTab === 'registro' ? 'active' : ''}`} onClick={() => setActiveTab('registro')}>Registro</div>
              </div>
              {activeTab === 'login' ? (
        ...
        <div className="card">
          ...
          {!usuario ? (
            <div className="empty-state"><FiList style={{ fontSize: '3em', color: '#cbd5e0' }} /><p>🔒 Inicia sesión para ver los reportes</p></div>
          ) : cargandoReportes ? (
            <div className="text-center p-4"><div className="loading"></div><p>Cargando...</p></div>
          ) : (
